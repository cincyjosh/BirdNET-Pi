...
<form action="views.php" method="GET">
  ...
  <div>
    <button type="submit" name="submit" id="updatebtn" value="sudo update_birdnet.sh" onclick="return update();">Update <?php if(isset($_SESSION['behind']) && $_SESSION['behind'] != "0" && $_SESSION['behind'] != "with"){?><div class="updatenumber"><?php echo $_SESSION['behind']; ?></div><?php } ?></button>
  </div>
  <div>
...
?>
  ...
  <a href="https://github.com/cincyjosh/BirdNET-Pi/commit/<?php echo $curr_hash; ?>" target="_blank">
